...
mixin RawEditorStateTextInputClientMixin on EditorState implements TextInputClient {
  ...
  final ValueNotifier<TextRange> composingRange = ValueNotifier<TextRange>(TextRange.empty);
  ...
  void updateFloatingCursor(RawFloatingCursorPoint point) {
    switch (point.state) {
      ...
      case FloatingCursorDragState.Update:
        ...
        _lastBoundedOffset = renderEditor.calculateBoundedFloatingCursorOffset(rawCursorOffset, preferredLineHeight);
